...
from ecg_lib.models.m_conv_1 import (
    ...
    conv_class_3 as cc_3        #late fusion (metadata insertion into ml stack after convolution/before fc1
    )
...
#training function
def m_train(train_loader, val_loader, cfg, rt_cfg):
    ...
    model = cc_3(
        ...
        metadata_size = rt_cfg.md_features_number
        )
    #============================================================
